...
const SmallNavbar = () => {
  return (
    <nav className="w-full h-28 flex flex-1 justify-between items-center gap-x-4 border-b-4 border-primary--pale-teal lg:hidden">
      <div
        id="menu-and-search"
      ...
      >
        ...
        <div className="w-10 h-10">
          <div className="flex flex-1 justify-center items-center">
            <div className={`w-10 h-10 ${styles.searchIcon}`}></div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="w-10 h-10 flex flex-1 justify-center items-center cursor-pointer">
          <div className={`w-10 h-10 ${styles.wishlistIcon}`}></div>
        </div>
        <div className="w-10 h-10 flex flex-1 justify-center items-center cursor-pointer">
          <div className={`w-10 h-10 ${styles.bagIcon}`}></div>
        </div>
      </div>
    </nav>
  );
